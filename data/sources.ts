...
export const SOURCES: SourceDef[] = [
  ...
  },
  {
    ...
    kind: 'news',
    lang: 'tr',
    blurb: 'Turkish headlines, read in Turkish.',
    available: true,
  },
  {
    id: 'news-world',
    ...
    kind: 'news',
    lang: 'en',
    blurb: 'International headlines from BBC, Al Jazeera, NPR, Guardian.',
    available: true,
  },
  {
    id: 'sports',
    ...
    kind: 'sports',
    lang: 'any',
    blurb: 'Latest football scores (Süper Lig, Premier League).',
    available: true,
  },
  {
    id: 'weather',
    ...
    kind: 'weather',
    lang: 'any',
    blurb: 'Today’s forecast for İstanbul and London.',
    available: true,
  },
];
